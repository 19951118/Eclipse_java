...
public class Java1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("javaでプログラムを開発するためには、コンパイラと、インタプリタというソフトウェアが必要です。コンパイラは、私達がjavaの文法に沿って記述したソースコードをバイトコードに変換してくれます。インタプリタは内部に持っているJVMの仕組みを使ってこれを解釈し、マシン語に変換してCPUに送り、CPUは命令を実行します。");
